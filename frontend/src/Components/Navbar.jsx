  ...
  return (
    <div>
      <nav>
        <div className="logo1">
          <img src={logo} alt="" />
          <div style={{ fontSize: '28px',fontWeight: '700', width: '200px', justifyContent: 'center', alignItems: 'center', display: 'flex', paddingLeft: '110px',paddingTop: '7px', cursor: 'pointer' }}>
            EduVenture<span style={{color:'#5e7fef',fontSize: '26px', margin:'0px', paddingLeft: '5px' }}>Academy</span>
          </div>
